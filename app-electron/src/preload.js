...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getProveedorById: (id) => ipcRenderer.invoke('proveedores:getProveedorById', id),
  getProveedorByName: (name) => ipcRenderer.invoke('proveedores:getProveedorByName', name),
  createProveedor: (proveedorData) => ipcRenderer.invoke('proveedores:create', proveedorData),
  updateProveedor: (id, updates) => ipcRenderer.invoke('proveedores:update', { id, updates }),
